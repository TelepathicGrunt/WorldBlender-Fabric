...
public class FeatureGrouping {
	...
	private final CodecCache<ConfiguredFeature<?, ?>> featureCache = CodecCache.of(ConfiguredFeature.CODEC);
	public final Map<GenerationStep.Feature, List<ConfiguredFeature<?, ?>>> smallPlants = Maps.newHashMap();
	...
	public final Map<GenerationStep.Feature, List<ConfiguredFeature<?, ?>>> largePlants = Maps.newHashMap();
	 ...
	 */
	public boolean isFireLavaBasalt(ConfiguredFeature<?, ?> configuredFeature) {
		...
		return containsBannedFeatureName(configuredFeatureJSON, BASALT_FEATURE_KEYWORDS)
			|| containsBannedState(configuredFeatureJSON, FIRE_STATE_KEYWORDS);
	}
	 ...
	 */
	public boolean checkAndAddSmallPlantFeatures(GenerationStep.Feature stage, ConfiguredFeature<?, ?> configuredFeature) {
	...
	/**
	 ...
	 we can have a list of them for specific feature manipulation later
	 */
	public boolean checkAndAddLargePlantFeatures(GenerationStep.Feature stage, ConfiguredFeature<?, ?> configuredFeature) {
